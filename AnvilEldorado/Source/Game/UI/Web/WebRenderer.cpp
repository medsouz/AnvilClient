...
bool WebRenderer::RegisterScheme(const std::string &p_Name, const std::experimental::filesystem::path &p_Directory)
{
	if (!std::experimental::filesystem::exists(p_Directory))
		return false;
